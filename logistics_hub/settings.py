...
EVOLUTION_SERVER_URL = env("EVOLUTION_SERVER_URL", "http://72.61.107.230:8081")
EVOLUTION_API_KEY = env("EVOLUTION_API_KEY", "HARO@2030")
EVOLUTION_INSTANCE_NAME = env("EVOLUTION_INSTANCE_NAME", "farshops")
EVOLUTION_NOTIFY_ENABLED = env_bool("EVOLUTION_NOTIFY_ENABLED", True)
EVOLUTION_VERIFY_SSL = env_bool("EVOLUTION_VERIFY_SSL", False)
PUBLIC_SITE_URL = env("PUBLIC_SITE_URL", "http://72.61.107.230:7096")
